---
title: "PBPK Model of PFAS Chemicals in Blood Serum - Adult Male"
...
The purpose of this model is to calculate the amount of PFAS, PFOA, PFHxS or PFNA (ug/L) in an individual's blood serum, given characteristics of the individual, their tap water concentration & consumption. It performs a Monte Carlo simulation to introduce variation into 14 different variables that define an individual for simulation. This specific example shows PFOA estimation for an adult male. 
...
param_list <- list(chemical = "PFOA", 
                   ...
                   # it also locks the weight provided to a man age 42
                   niter = 1000, 
                   timestep = 30,
...
save(results, file = here("output", "PBPK", Sys.Date(), "PBPK_Male.Rdata"))
load(file = here("output", "PBPK", Sys.Date(), "PBPK_Male.Rdata"))
