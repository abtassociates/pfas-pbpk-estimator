...
```{r plot-settings}
plot_title <- "40 year old male"
out_name <- "40M"

drop_vars <- c("conc_t1", "MatRemove", "MilkClearance", "PlacXfer", "MatXfer")
vars_order = c("T[1/2] (years)", "V[d] (L/kg)", "DWI (μg/L)", "C[bgd] (μg/L)",
               "BW (kg)", "Percent Tap (%)", "DWC (μg/L)")
```
...
# plot
g <- ggtornado(data = dframe, baseline = 4.4,
...
g <- ggtornado(data = dframe, baseline = 8.9,
          var = "var", level = "level", value = "value", result = "pred_serum_ug_L",
          Bkgd = 5.362624307,
          var_order = vars_order)
...
g <- ggtornado(data = dframe, baseline = 15.5,
          var = "var", level = "level", value = "value", result = "pred_serum_ug_L" ,
          Bkgd = 1.483322954, var_order = vars_order)
...
g <-  ggtornado(data = dframe, baseline = 5.1,
          var = "var", level = "level", value = "value", result = "pred_serum_ug_L",
          Bkgd = 0.441664167,
          var_order = vars_order)
