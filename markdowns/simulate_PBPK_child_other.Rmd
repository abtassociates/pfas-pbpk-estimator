---
title: "PBPK Model of PFAS Chemicals in Blood Serum - Child fed store bought formula"
...
param_list <- list(chemical = "PFOA", # PFAS chemical
                   ...
                   BW = 46, # user current body weight (kg) (on the )
                   
                   # If you are a child: (ignored if over 6 years old)
                   
                   fed_most = "other formula", # user was fed mostly "breast milk", 
                   # "tap water", or "other formula" when they were an infant. 
                   fed_mo = 12, # for how many months? (ignored when fed_most = "tap water")
                   ...
                   sd = as.Date("2018-1-1"), # start date of simulation, user's birthdate   (yyyy-m-d)
...
save(results, file = here("output", "PBPK", Sys.Date(), "PBPK_Child_Other.Rdata"))
load(file = here("output", "PBPK", Sys.Date(), "PBPK_Child_Other.Rdata"))
